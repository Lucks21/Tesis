{{-- 
    Filtros de búsqueda para Búsqueda Simple con UN SOLO FORMULARIO
    Configurado específicamente para la ruta busqueda.sp
...
<div class="filters-sidebar space-y-3">
    ...
    <form method="GET" action="{{ route('busqueda.sp') }}" id="filtros-form" class="space-y-3">
        {{-- Campos hidden para mantener parámetros de búsqueda de Búsqueda Simple --}}
        ...
        {{-- Botón de aplicar filtros (opcional, ya que también se puede hacer automático) --}}
        <div class="mt-4">
